...
window.JAYCO_DIFFERENCE = (function () {
  ...
  const towable = [
    { icon: 'roof', name: 'Magnum Truss™ Roof System',
      ...
      body: 'Standard on every Jayco travel trailer and fifth wheel, and the strongest roof in the business — 50% more weight than competitors\' roofs.' },
    { icon: 'wall', name: 'Stronghold VBL™ Laminated Walls',
      stat: { fig: '144 tons', cap: 'Of pressure, for 16+ minutes' },
      body: 'Aluminum frame, fiberglass, metal backers and the interior panel, vacuum-bonded into one wall — the lightest, yet strongest, construction in the RV industry.' },
    ...
    { icon: 'temp', name: 'Climate Shield',
      ...
      body: 'A fully enclosed, heated underbelly, a 35,000 BTU furnace, double-layer fiberglass insulation and a double-sided radiant barrier. On select models, such as Eagle.' },
    { icon: 'shield', name: 'The Jayco 2+3 Warranty',
      stat: { fig: '2 + 3', cap: 'Years limited + structural' },
      body: 'Two years of limited coverage plus three years of structural protection — a limited warranty twice as long as any other manufacturer\'s. Supplier warranties run to a lifetime on top.' },
  ...
  const motorized = [
    ...
    { icon: 'shield', name: 'The Jayco 2+3 Warranty',
      ...
      body: 'Two years of limited coverage — 24 months or 24,000 miles, whichever comes first — plus three years of structural protection. Jayco\'s limited warranty is twice as long as any other manufacturer\'s.' },
    { icon: 'cap', name: 'One-Piece Seamless Front Caps',
      body: 'A single molded cap with no seam for moisture or road debris to work at, which is one less thing to service later.' },
    ...
    { icon: 'wall', name: 'Stronghold VBL™ Laminated Walls',
      body: 'The same vacuum-bonded wall the towables are built with: frame, fiberglass and interior panel bonded through the whole process.' },
  ...
  const cutaways = [
    ...
    { where: 'Walls', name: 'Stronghold VBL™ Laminated Walls',
      body: 'Aluminum frame, fiberglass, metal backers and interior panel, vacuum-bonded under 144 tons of pressure for a minimum of 16 minutes.' },
    { where: 'Underbelly', name: 'Climate Shield',
      body: 'Fully enclosed and heated, with double-layer fiberglass insulation in the ceiling and floor and a double-sided radiant barrier — for camping from 0°F to 100°F. On select models, such as Eagle.' },
    ...
    { id: 'motorized', label: 'Motorized', img: 'construction-motorized',
      ...
      layers: [
    { where: 'Walls', name: 'Stronghold VBL™ Laminated Walls',
      body: 'The same vacuum-bonded wall the towables are built with — frame, fiberglass and interior panel bonded into one through the whole process.' },
  ...
  const warranties = [
    ...
    { what: 'Aluminum wheels', who: 'Tredit™', years: null },
  ];
  ...
  const community = [
    { fig: '52,870', cap: 'Members of the Jayco RV Club, Jayco\'s largest owners group (as of February 2025)' },
