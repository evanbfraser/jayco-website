...
(function () {
  ...
  picker('ntr-space', [
    { label: 'Sleeps 1–2',
      sub: 'Solo travelers and couples.',
      head: HEAD_SLEEP,
      cats: ['class-b', 'travel-trailers', 'class-c'],
      count: sleepCount(2),
  ...
  const START = [
    ...
    { id: 'class-c', img: 'type-c',
      ...
      why: 'The usual way into a motorhome. You drive it rather than tow it, and it places and parks more easily than a Class A — the cab you sit in is one you already recognize.' },
    ...
    { id: 'destination', img: 'type-dt',
      ...
      why: 'Built to be towed to a spot and stayed in — residential fittings, tall windows, and a layout closer to a small vacation home than to something you move every weekend.' },
    { id: 'class-a', img: 'type-a',
      ...
      why: 'The largest motorhome here, on its own chassis behind a flat front and a full-width windshield. The most living space you can drive, and the most of it to place.' },
